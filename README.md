...
2- En suite nous devons trouver n dans l'équation suivante 2<sup>n </sup> = 300, on truve donc n= 8,22 mais nous allons prendre n = 9 afin d'avoir assez d'adresses (donc ici nous aurons 512 adresses.
